      ...
      <div class="grid grid-flow-row-dense grid-cols-3  ">
            ...
            <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl lg:max-w-xl">
              ...
              <div className="mt-6">
                <div className="mb-2">
                  ...
                  <input type="text" id="username" onChange={handleChange} name="username"
                ...
                <div className="mt-6">
                  <button onClick={handleSubmit} id="register_Submit"
        ...
        <div className=" w-full z-50  -ml-4 shadow-md">
          <div className="relative flex flex-col justify-center h-full overflow-hidden">
            <div
              className="w-full h-full m-auto flex justify-center items-center  p-6 m-auto  bg-primary rounded-md shadow-xl lg:max-w-xl">
              <div className="h-full w-full flex items-center justify-center">
                <div className=" h-full w-full flex text-center flex-col space-y-5 items-center justify-center ">
                  ...
                  <div>
                    <a href="./register" className="bg-blue-600 text-white font-bold py-2 px-10 rounded-full">
                      SIGN UP
                    </a>
                  </div>
                </div>
