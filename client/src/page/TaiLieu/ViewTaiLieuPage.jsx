      ...
      <div className="w-full">
          ...
          <div className=" ">
            ...
            >
              <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                  <Link to="/tailieu" class="flex items-center">
                    <svg
        ...
        <div className="w-[98%] flex  my-2 mx-2 ">
          <div className="rounded-lg">
            <div className="flex w-full justify-start items-center  border-t border-b border-green-200 text-green-300 ">
              <img
                className="h-14 w-14 rounded-full"
                src={data?.createrPhoto}
              />
              <div class=" px-4 py-3" role="alert">
                <p class="font-bold hover:text-blue-400 cursor-pointer">
                  {data?.creater}
                </p>
